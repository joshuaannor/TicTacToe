...
namespace CrawfisSoftware
{
    class TicTacToeAI
    {
        ...
        {
            Console.WriteLine("Welcome to Tic Tac Toe Random AI!");
            CreateGame();
        ...
        {
            Console.WriteLine("Welcome to Tic Tac Toe (Player vs. Random AI)!");
            Console.WriteLine("Instructions:");
            Console.WriteLine("1. The game is played on a 3x3 grid.");
            Console.WriteLine("2. You (the player) will take turns with a random AI opponent.");
            ...
            Console.WriteLine("6. The AI will randomly select an available cell to place its mark.");
